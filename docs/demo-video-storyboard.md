...
4. Select a message and show the raw payload inspector.
   Voiceover: "The source label is backed by provenance, not just a colored badge."
...
7. End on `docs/evidence/manifest.md`.
   Voiceover: "The repo includes tests, proof logs, screenshots, deployment config, and submission copy."
...
- Keep the final edit short enough to watch without scrubbing.
